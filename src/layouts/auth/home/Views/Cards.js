...
const cardAtHomes = () => {
  return (
        <div className="containerAtHome">
  <p className="containerAtHome-title">Here are the features we’re proud of</p>

  <div className="gradient-cardAtHomes">
    <div className="cardAtHome">
      <div className="containerAtHome-cardAtHome bg-green-box">
        ...
        <p className="cardAtHome-title">Zero-cost Possibilities</p>
        <p className="cardAtHome-description">Hubble lets users borrow USDH for a one-time 0.5% fee. No variable rates. No interest charged, ever.</p>
      </div>
    </div>

    <div className="cardAtHome">
      <div className="containerAtHome-cardAtHome bg-white-box">
        <svg width="80" height="80" viewBox="0 0 120 120" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <p className="cardAtHome-title">Multi-Asset Collateral</p>
        <p className="cardAtHome-description">Deposit a variety of assets on Hubble, raise your collateral ratio, and unlock the liquidity in your wallet.</p>
      </div>
    </div>

    <div className="cardAtHome">
      <div className="containerAtHome-cardAtHome bg-yellow-box">
        <svg width="80" height="80" viewBox="0 0 120 120" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <p className="cardAtHome-title">Get Yield on Deposits</p>
        <p className="cardAtHome-description">While your collateral is deposited, delegate it to earn the highest yield available in the Solana ecosystem.</p>
      </div>
    </div>

    <div className="cardAtHome">
      <div className="containerAtHome-cardAtHome bg-blue-box">
        <svg width="80" height="80" viewBox="0 0 120 120" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <p className="cardAtHome-title">Get up to 11x Leverage</p>
        <p className="cardAtHome-description">Hubble’s capital-efficient 110% collateral ratio lets users leverage up to 11x on their deposits.</p>
      </div>
    </div>
  </div>
</div>
